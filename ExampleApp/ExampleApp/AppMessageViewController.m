...
- (instancetype)initWithAppInfo:(AppInfo *)appInfo {
    if ((self = [super initWithNibName:nil bundle:nil])) {
        const char bytes[] = {0x10, 0x20, 0x30};
        _appInfo = appInfo;
        _logMessages = [NSMutableArray array];
        _tableEntries = @[
            [TableEntry entryWithLabel:@"Send open app request" message:nil],
            [TableEntry entryWithLabel:@"Bool" message:@YES],
            [TableEntry entryWithLabel:@"Integer" message:@1],
            [TableEntry entryWithLabel:@"Character" message:@'K'],
            ...
            [TableEntry entryWithLabel:@"Byte Array" message:[[NSData alloc] initWithBytes:bytes length:sizeof(bytes)]],
